...
os.execute('lua homlandBOIQ.lua')
end
...
echo -e "\033[0;00m"
echo -e "\e[36m"
./tg -s ./homlandBOIQ.lua -p PROFILE --bot=$token
done
]])  
file:close()  
file = io.open("HM", "w")  
...
while(true) do
rm -fr ../.telegram-cli
screen -S homlandBOIQ -X kill
screen -S homlandBOIQ ./homlandBOIQ
done
]])  
file:close() 
...
─────▀██▀─────
┊homeland ‿ @hu4_yaB
تم تطوير وبرمجة السورس من قبل مطورين سورس وطن ┊
...
local homlandBOIQ_Msg = ''  
if msgs < 100 then 
homlandBOIQ_Msg = 'غير متفاعل😔💔' 
elseif msgs < 200 then 
homlandBOIQ_Msg = 'رايدله مولده🤣😜😕💔' 
elseif msgs < 400 then 
homlandBOIQ_Msg = 'شبه متفاعل😗👻' 
elseif msgs < 700 then 
homlandBOIQ_Msg = 'متفاعل😍🙊' 
elseif msgs < 1200 then 
homlandBOIQ_Msg = 'متفاعل قوي😍✔️' 
elseif msgs < 2000 then 
homlandBOIQ_Msg = 'متفاعل جدا😍💘' 
elseif msgs < 3500 then 
homlandBOIQ_Msg = 'اقوى تفاعل🙊👻'  
elseif msgs < 4000 then 
homlandBOIQ_Msg = 'متفاعل نار😍🔥' 
elseif msgs < 4500 then 
homlandBOIQ_Msg = 'قمة التفاعل🤸‍♂️😻' 
elseif msgs < 5500 then 
homlandBOIQ_Msg = 'اقوى متفاعل😳😻' 
elseif msgs < 7000 then 
homlandBOIQ_Msg = 'ملك التفاعل🤴😍' 
elseif msgs < 9500 then 
homlandBOIQ_Msg = 'امبروطور التفاعل💂‍♀️😻' 
elseif msgs < 10000000000 then 
homlandBOIQ_Msg = 'رب التفاعل✔️😍'  
end
return homlandBOIQ_Msg 
end
function GetFile_Bot(msg)
local list = database:smembers(bot_id..'Chek:Groups') 
local t = '{"BOT_ID": '..bot_id..',"GP_BOT":{'  
for k,v in pairs(list) do   
NAME = 'homlandBOIQ Chat'
...
--------------------------------------------------------------------------------------------------------------
function SourcehomlandBOIQ(msg,data) -- بداية العمل
if msg then
...
send(msg.chat_id_, msg.id_,homlandBOIQ_Msg) 
return false  
end 
if text then    
...
os.execute('rm -rf homlandBOIQ.lua')
os.execute('wget https://raw.githubusercontent.com/sourcehomeland/homlandBOIQ/master/homlandBOIQ.lua')
send(msg.chat_id_, msg.id_,'🔭| تم تحديث البوت \n📮| لديك اخر اصدار سورس وطن\n📡| الاصدار ← { 2.0v}')
dofile('homlandBOIQ.lua')  
end
if text == 'تحويل للسورس بويكا' and SudoBot(msg) then 
os.execute('rm -rf homlandBOIQ.lua')
os.execute('wget https://raw.githubusercontent.com/sourcehomeland/homlandBOIQY/master/homlandBOIQ.lua')
send(msg.chat_id_, msg.id_,'تحويل للسورس بويكا') 
dofile('homlandBOIQ.lua')  
end
if text == 'تحويل للسورس كلاكسي' and SudoBot(msg) then 
os.execute('rm -rf GALAXY.lua')
os.execute('wget https://raw.githubusercontent.com/sourcehomeland/GALAXYY/master/GALAXY.lua')
send(msg.chat_id_, msg.id_,'تحويل للسورس كلاكسي') 
dofile('GALAXY.lua')  
end
if text == 'تحويل للسورس ماركوس' and SudoBot(msg) then 
os.execute('rm -rf homlandBOIQ.lua')
os.execute('wget https://raw.githubusercontent.com/sourcehomeland/MARCOSBOT/master/homlandBOIQ.lua')
send(msg.chat_id_, msg.id_,'تحويل للسورس ماركوس') 
dofile('homlandBOIQ.lua')  
end
if text == 'تحويل للسورس عالمي' and SudoBot(msg) then 
os.execute('rm -rf GLOBLA.lua')
os.execute('wget https://raw.githubusercontent.com/sourcehomeland/GLOBLA/master/GLOBLA.lua')
...
local homlandBOIQ = (w + q)
local sendok = #group - homlandBOIQ
if q == 0 then
homlandBOIQ = ''
else
...
send(msg.chat_id_, msg.id_,'📌¦ عدد المجموعات الان » { '..#group..' }'..homlandBOIQk..''..homlandBOIQ..'\n*📌| الان عدد المجموعات الحقيقي » { '..sendok..' } مجموعات\n')   
end
end
end,nil)
end
...
--------------------------------------------------------------------------------------------------------------
if homlandBOIQ_Msg and not Special(msg) then  
local homlandBOIQ_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if homlandBOIQ_Msg then    
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
...
usertext = '\n👤| المستخدم » ['..result.title_..'](t.me/'..(username or 'homlandBOIQ')..')'
status  = '\n🔘| تم حظره من المجموعه'
texts = usertext..status
chat_kick(msg.chat_id_, result.id_)
send(msg.chat_id_, msg.id_, texts)
...
t = "\n🔘| قائمة المنع \nء━━━━━━━━━━━━\n"
for k,v in pairs(list) do  
local homlandBOIQ_Msg = database:get(bot_id.."Add:Filter:Rp2"..v..msg.chat_id_)   
t = t..''..k..'- '..v..' » {'..homlandBOIQ_Msg..'}\n'    
end  
if #list == 0 then  
...
send(msg.chat_id_, msg.id_,'['..homlandBOIQ_Msg[math.random(#homlandBOIQ_Msg)]..']') 
return false
end
...
},function(ta,homlandBOIQ)
local t = "\n🔘| قائمة الاعضاء \nء━━━━━━━━━━━━\n"
x = 0
local list = homlandBOIQ.members_
for k, v in pairs(list) do
x = x + 1
...
send(msg.chat_id_, msg.id_,'['..homlandBOIQ[math.random(#homlandBOIQ)]..']') 
return false
end
--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
if text == "زخرفه" or text == "زخرفلي"  then  
redis:setex(homlandBOIQ..":ZhrfNow:"..msg.sender_user_id_,500,true)
sendMsg(msg.chat_id_,msg.id_,"📑| حسننا , الان يمكنك ارسال الاسم 💯")    
return false
end

if redis:get(homlandBOIQ..":ZhrfNow:"..msg.sender_user_id_) then
redis:del(homlandBOIQ..":ZhrfNow:"..msg.sender_user_id_)
...
if msg.text and msg.type ~= "pv" and redis:get(homlandBOIQ..":ZhrfNow:"..msg.sender_user_id_) then
Text = msg.text
redis:del(homlandBOIQ..":ZhrfNow:"..msg.sender_user_id_)
if utf8.len(msg.text) > 300 then
...
send(msg.chat_id_, msg.id_,'['..homlandBOIQSource[math.random(#homlandBOIQSource)]..']') 
return false
end
--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
local Name_Bot = (redis:get('homlandBOIQ:'..bot_id..'Name:Bot') or 'العالمي')
if not redis:get('homlandBOIQ:'..bot_id.."Fun_Bots:"..msg.chat_id_) then
...
-------------------------------------------------------------------------------------------------------------- 
if text and redis:get('homlandBOIQ:'..bot_id.."Del:Cmd:Group"..msg.chat_id_..":"..msg.sender_user_id_) == "true" then
local NewCmmd = redis:get('homlandBOIQ:'..bot_id.."Set:Za:Group:New1"..msg.chat_id_..":"..text)
if NewCmmd then
redis:del('homlandBOIQ:'..bot_id.."Set:Za:Group:New1"..msg.chat_id_..":"..text)
redis:del('homlandBOIQ:'..bot_id.."Set:Za:Group:New"..msg.chat_id_)
redis:srem('homlandBOIQ:'..bot_id.."List:ZaYon:Group:New"..msg.chat_id_,text)
...
redis:del('homlandBOIQ:'..bot_id.."Del:Cmd:Group"..msg.chat_id_..":"..msg.sender_user_id_)
return false
end
---------------
if text then
local NewCmmd = redis:get('homlandBOIQ:'..bot_id.."Set:Za:Group:New1"..msg.chat_id_..':'..data.message_.content_.text_)
if NewCmmd then
data.message_.content_.text_ = (NewCmmd or data.message_.content_.text_)
end
end
...
--------------------------------------------------------------------------------------------------------------
if msg.content_.ID == "MessageChatAddMembers" then  
redis:set('homlandBOIQ:'..bot_id.."Who:Added:Me"..msg.chat_id_..':'..msg.content_.members_[0].id_,msg.sender_user_id_)
local mem_id = msg.content_.members_  
local Bots = redis:get('homlandBOIQ:'..bot_id.."lock:Bot:kick"..msg.chat_id_) 
for i=0,#mem_id do  
if msg.content_.members_[i].type_.ID == "UserTypeBot" and not Mod(msg) and Bots == "kick" then   
https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..msg.sender_user_id_)
homlandBOIQ = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_config = JSON.decode(homlandBOIQ)
...
if Constructor(msg) then 
redis:set('homlandBOIQ:'..bot_id..'Pin:Id:Msg'..msg.chat_id_,msg.content_.message_id_)
else
local Msg_Pin = redis:get('homlandBOIQ:'..bot_id..'Pin:Id:Msg'..msg.chat_id_)
if Msg_Pin and redis:get('homlandBOIQ:'..bot_id.."lockpin"..msg.chat_id_) then
...
if redis:get('homlandBOIQ:'..bot_id..'lock:tagservr'..msg.chat_id_) then  
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false
end    
end   
--------------------------------------------------------------------------------------------------------------
DevhomlandBOIQ(data.message_,data)
--------------------------------------------------------------------------------------------------------------
if Chat_Type == 'GroupBot' and Groups_Users(msg.chat_id_) == true then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ then
redis:set('homlandBOIQ:'..bot_id..'user:Name'..msg.sender_user_id_,(data.username_))
end
--------------------------------------------------------------------------------------------------------------
...
------------------------------------------------------------------------
local homlandBOIQbot = database:get(bot_id.."Add:Filter:Rp2"..text..result.chat_id_)   
if homlandBOIQbot then    
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0,"⚠¦العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n📛¦["..homlandBOIQbot.."] \n") 
else
